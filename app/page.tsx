    ...
    <div className="min-h-screen bg-gradient-to-br from-[#3d1cb3] via-[#5b35d5] to-[#2d1585]">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-10 md:py-14">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <a
              ...
              className="bg-[#ffe600] hover:bg-[#f5dc00] text-[#3d1cb3] font-extrabold px-7 py-3.5 rounded-full text-sm transition-all duration-200"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-24 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
          ...
          <span className="text-[#ffe600]">Logistics Platform</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/dashboard"
            className="bg-[#ffe600] hover:bg-[#f5dc00] text-[#3d1cb3] px-8 py-4 rounded-xl font-bold text-lg transition-all duration-200"
          >
      ...
      {/* Stats */}
      <div id="stats" className="bg-[#2d1585] border-t border-white/10">
          ...
          {[
            ...
            return (
              <div key={stat.label} className="text-center">
                <Icon className="mx-auto mb-2 text-[#ffe600]" size={28} />
          ...
          {[
            ...
            return (
              <div key={feat.title} className="bg-white rounded-xl p-6 border-l-4 border-[#ffe600] hover:shadow-xl transition-all duration-200 shadow-sm">
                <div className="w-12 h-12 bg-[#3d1cb3]/10 rounded-xl flex items-center justify-center mb-4">
                  <Icon className="text-[#3d1cb3]" size={22} />
                </div>
                <h3 className="text-[#3d1cb3] font-semibold text-lg mb-2">{feat.title}</h3>
      ...
      <div className="bg-[#ffe600] py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-[#3d1cb3] mb-4">Ready to transform your logistics?</h2>
          <p className="text-[#3d1cb3]/70 mb-8">Join 500+ Nigerian logistics companies already using LogiTrack NG</p>
          <Link
            href="/dashboard"
            className="bg-[#3d1cb3] hover:bg-[#2d1585] text-white px-10 py-4 rounded-xl font-bold text-lg transition-all duration-200 inline-block"
          >
